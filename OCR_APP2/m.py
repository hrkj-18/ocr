...
thumb.save('/home/simran/Desktop/OCR_APP2/x.jpg')
image = cv2.imread('/home/simran/Desktop/OCR_APP2/x.jpg')
...
while True:
	...
	if key == ord("s"):
		cv2.imwrite("bw_warped.jpg", clone)
		break
...
if len(refPt) == 4:
	...
	cv2.imwrite("/home/simran/Desktop/OCR_APP2/cropped.jpg", cropped)
	#cv2.imshow("cropped", cropped)
	#cv2.waitKey(0)
	black_and_white('/home/simran/Desktop/OCR_APP2/cropped.jpg',
        '/home/simran/Desktop/OCR_APP2/bw_cropped.jpg')
	img = cv2.imread('/home/simran/Desktop/OCR_APP2/bw_cropped.jpg')
